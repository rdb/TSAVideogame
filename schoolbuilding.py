...
class MyApp(ShowBase):
    def manaupdate(self, task):
        self.manaamount = self.manaamount + .02
...
#        print(camera_position)
        ...
        # Separation logic to prevent NPC overlap
            ...
            repelling_force = 1  # Strength of the repelling force
